...
from reeferMon import monitor
from pathlib import Path

# this is how to setup Testing......
...
class TestSimpleFilter(unittest.TestCase):
    ...
    def test_monitor(self):
        ...
        topology = monitor(job_name="testMonitor", name_space="testMonitor",
                           mh_topic="jsonEvents", redis_base="/score")
